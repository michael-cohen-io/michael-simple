...
/**
 * The inside of the "Ask Claude About Me" box, loaded the first time the
 * box is opened (ask.tsx is the shell that stays in the page's own
 * bundle). The answer comes from
