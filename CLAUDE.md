...
One-page personal site: Next.js 15 (App Router, static export to `out/`), React 19, Tailwind CSS, a few shadcn/ui primitives, Raleway via `next/font`. Deployed on Vercel as static files.
